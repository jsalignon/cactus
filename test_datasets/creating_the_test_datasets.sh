...
creating_test_ds_dir=$cactus_dir/test_datasets/creating_the_test_datasets
creating_test_datasets_bin_dir=$creating_test_ds_dir/bin
samples_ids_dir=$creating_test_ds_dir/samples_ids
...
source $creating_test_datasets_bin_dir/creating_test_datasets_functions.sh
...
source $creating_test_datasets_bin_dir/0__getting_genome_sizes.sh
...
source $creating_test_datasets_bin_dir/1__get_fastq.sh $species
...
source $creating_test_datasets_bin_dir/2__subsample_reads.sh $species $n_reads_atac $n_reads_mrna
source $creating_test_datasets_bin_dir/3__making_design_files__worm.sh $n_reads_atac $n_reads_mrna
...
source $creating_test_datasets_bin_dir/2__subsample_reads.sh $species $n_reads_atac $n_reads_mrna
source $creating_test_datasets_bin_dir/3__making_design_files__fly.sh $n_reads_atac $n_reads_mrna
...
source $creating_test_datasets_bin_dir/2__subsample_reads.sh $species $n_reads_atac $n_reads_mrna
source $creating_test_datasets_bin_dir/3__making_design_files__mouse.sh $n_reads_atac $n_reads_mrna
...
source $creating_test_datasets_bin_dir/2__subsample_reads.sh $species $n_reads_atac $n_reads_mrna
source $creating_test_datasets_bin_dir/3__making_design_files__human.sh $n_reads_atac $n_reads_mrna
...
source $creating_test_datasets_bin_dir/making_application_note_dirs.sh
...
species="worm" ; n_reads_atac=200 ; n_reads_mrna=50
source $creating_test_datasets_bin_dir/3__making_design_files__${species}.sh $n_reads_atac $n_reads_mrna
