...
This section covers the inputs files needed by Cactus. There are 3 kind of inputs files: 
 - [data](/docs/3_Inputs/fastq.md) (*.fastq.gz* files): raw sequencing output files
 - [design](/docs/3_Inputs/tsv.md) (*.tsv* files): to indicate the design of the experiment; that is how fastq files relate to samples and conditions, and comparisons to perform and groups of comparisons to plot together in the heatmaps
 - [options](/docs/3_Inputs/Configuration.md) (*.config* files): to indicate the parameters to use for the current analysis run. This is the only needed input file for a cactus call.
