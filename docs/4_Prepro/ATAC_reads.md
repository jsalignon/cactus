...
- Percentage of sampled aligned reads that overlap with:
  - the mitochondrial genome
  - genomic annotations: promoters, exons, introns, intergenic regions, genic regions.

- Sampled aligned reads are also used to estimate library complexity.
