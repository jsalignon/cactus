...
### Outputs
- **PCA plots**: `pca_{raw,log2}_top{100,1000,5000}_${gDNA_PRESENT}_pca.pdf`) in `Figures_Individual/1_Preprocessing/ATAC__reads__PCA` and
...
### Outputs
- **insert size plots** (`${sample}__insert_size.pdf`) in `Figures_Individual/1_Preprocessing/ATAC__reads__insert_size`.
