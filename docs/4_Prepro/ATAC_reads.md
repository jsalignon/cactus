...
### Outputs
- **Merged reads**: `Processed_Data/1_Preprocessing/ATAC__reads__fastq_merged/${sample}_R{1,2}_merged.fastq.gz` if *params.save_fastq_type = 'all'*.
...
<img src="/docs/examples/png/spearman_correlation_heatmap_without_outliers_without_control_cor.png" width="400" />
...
<img src="/docs/examples/png/ctl_1__insert_size.png" width="400" />
...
### Outputs
- **MultiQC report**: `ATAC__multiQC.html`. [Example](https://htmlpreview.github.io/?https://github.com/jsalignon/cactus/blob/main/docs/examples/html/ATAC__multiQC.html).
