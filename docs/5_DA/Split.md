...
4 filters are used to split:
  ...
  - PA: DAR Peak Annotation. Can be any combination of 'all', 'PA_gene', 'PA_interG', 'PA_prom', 'PA_5pUTR', 'PA_3pUTR', 'PA_exon', 'PA_intron', 'PA_downst', 'PA_distIn', 'PA_UTR', 'PA_TSS', 'PA_genPro', 'PA_distNC', 'PA_mt_10kb', 'PA_mt_100kb', 'PA_mt_1mb', 'PA_lt_10kb', 'PA_lt_100kb', 'PA_lt_1mb'. See [DA_ATAC__saving_detailed_results_tables](/docs/5_DA/DA_ATAC.md#DA_ATAC__saving_detailed_results_tables) for details. 'all' disable this filters (all peaks are included).
