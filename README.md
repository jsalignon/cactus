...
***Overview of Cactus.***   
Overview of Cactus. (a) Key features. Icons of species were obtained and adapted from Servier Medical Art (https://smart.servier.com/) and the Database Center for the life sciences/TogoTV (https://togotv.dbcls.jp/en/pics.html). (b) Simplified workflow. (c) Example of enrichment analysis performed for a gene showing an increase in both chromatin accessibility and gene expression upon treatment. Enrichment of internal GR and GS indicates enrichment of GR and GS with other GR and GS generated by the pipeline. Black lines and blue circles represent DNA and nucleosomes, respectively. Orange lines represent mRNA molecules. (d) Sub-workflow showing the creation of Differential Analysis Subsets (DASs). Dotted arrows indicate optional additional filters. Abbreviations: DAR, Differentially Accessible Region; DEG, Differentially Expressed Gene; ChIP, ChIP-Seq binding sites; motifs, DNA binding motifs; FDR, False Discovery Rate; prom, promoter; distNC, distal non-coding region.  
