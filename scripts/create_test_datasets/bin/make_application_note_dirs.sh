...
cat application_note/$species/design/atac_fastq.tsv

############################################################
# worm: adding the hmg-3 mRNA and ATAC -Seq samples

design_dir="application_note/worm/design/"
...
data_dir=application_note/worm/data
...
replace_spaces_by_tabs_in_the_design_tsv_files application_note/worm
